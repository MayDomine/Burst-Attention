# Contributing to Burst-Attention
...
There are many ways that you can contribute to Burst-Attention:
...
```git
$ git clone https://github.com/<your GitHub>/Burst-Attention.git
$ cd Burst-Attention
$ git remote add upstream https://github.com/OpenBMB/Burst-Attention.git
```
